...
```{r, warning=FALSE, message=FALSE}
correlation_goal <- ggplot(sdr_data, aes(x = goal_5_score, 
...
- Edit the code chunk above to plot a linear regression of 2 different sdg scores 
  ...
  - in 4-6 sentences, come up with a hypotheses for the positive or negative correlation between the 2 goals
      Based on my hypothesis, there seems to both positive and negative correlation between the SDG goal 5 and goal 9.  The United States seems to have a positive correlation for SDG goal 9 versus goal 5.  Sweden shows both positive correlation for both goals.  Countries such as Somalia, Chad and Afghanistan are leaning more on a negative for both SDG goals. 
