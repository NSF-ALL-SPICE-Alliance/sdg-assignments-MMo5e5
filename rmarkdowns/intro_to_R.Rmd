...
Create a my_name variable with your name assigned to the variable instead of "Victoria DelaCruz". Then, create a my_age variable with your age. instainst
...
```{r}
sdr_data %>%
  select(goal_5_score, goal_9_score)
```
```{r}
sdr_data %>%
  select(goal_5_score, goal_9_score)
